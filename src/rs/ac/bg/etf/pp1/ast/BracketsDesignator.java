...
public class BracketsDesignator extends DesignatorLeft {

    private DesignatorLeft DesignatorLeft;
    private LBrackOpen LBrackOpen;
    private Expression Expression;

    public BracketsDesignator (DesignatorLeft DesignatorLeft, LBrackOpen LBrackOpen, Expression Expression) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("BracketsDesignator(\n");
