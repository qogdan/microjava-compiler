...
public class MulDeclarationsOneType extends VarDeclarations {

    private VarItem VarItem;
    private VarDeclarations VarDeclarations;

    public MulDeclarationsOneType (VarItem VarItem, VarDeclarations VarDeclarations) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MulDeclarationsOneType(\n");
